...
const places = [
  { name: 'Goa', type: 'Coastline', categories: ['Outdoors', 'Stay'], mood: 'Slow mornings and clear water', position: '0% 50%' },
  { name: 'Jaipur', type: 'Heritage', categories: ['Culture', 'Food'], mood: 'Courtyards, craft, and late lunches', position: '50% 50%' },
  { name: 'Ladakh', type: 'Outdoors', categories: ['Outdoors', 'Stay'], mood: 'Cold air and wide-open trails', position: '100% 50%' },
];
